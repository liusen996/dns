...
BASEIMAGE ?= harbor.weizhipin.com/tcloud/k8s.gcr.io/build-image/debian-base-$(ARCH):bullseye-v1.3.0
IPTIMAGE ?= harbor.weizhipin.com/tcloud/k8s.gcr.io/build-image/debian-iptables-$(ARCH):bullseye-v1.3.0
